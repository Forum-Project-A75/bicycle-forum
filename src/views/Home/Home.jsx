...
} from '../../Services/db.statistics.services/statistics.services.js';
...
export default function Home() {
  ...
  useEffect(() => {
    async function fetchPostsData() {
      try {
        const resultLatestPosts = await getLatestPosts(
          HOME_GET_LATEST_POSTS_COUNT,
        );
      ...
      try {
        const resultMostCommentedPosts = await getMostCommentedPosts(
          HOME_GET_MOST_COMMENTED_POSTS_COUNT,
        );
